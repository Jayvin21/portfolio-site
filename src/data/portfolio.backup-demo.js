...
export const projects = [
  ...
  {
    title: "HRFlow",
    subtitle: "HR Operations System",
    description:
      "Full-stack HR workflow dashboard for candidate tracking, employee records, approvals, role-based views, and internal HR analytics.",
    tech: ["React", "Node.js", "Express", "MongoDB", "JWT", "Dashboards"],
    demo: "#",
    github: "#",
    live: "#",
    visual: "dashboard",
    status: "MVP Build",
    images: ["/projects/hrflow/hrflow-preview.svg"],
  },
  {
    title: "Compliance AI",
